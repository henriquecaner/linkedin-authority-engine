...
This skill is the **bank** of CTAs. To diagnose why a specific post's close is weak and get 3-5 rewritten alternatives for the goal, use the `cta-optimizer` skill — it loads this bank and applies it to one post.
