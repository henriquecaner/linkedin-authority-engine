---
name: linkedin-authority-engine:linkedin
description: Mode menu for the LinkedIn Authority Engine. Shows Onboarding, Guided, Rewrite, Thread and Score and routes to the chosen mode.
---
