---
name: linkedin-authority-engine:score
description: Score Mode of the LinkedIn Authority Engine — evaluates and humanizes a finished post, running technical validation, humanizer and a score across the 6 dimensions with a final verdict (publish / adjust / rework).
---
