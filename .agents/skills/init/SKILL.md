---
name: linkedin-authority-engine:init
description: Client onboarding. Runs the discovery interview and creates authority-context.md in the project folder, plus memory/ and outputs/posts/. Supports --refresh to update an existing profile.
---
