...
Optionally run `${CLAUDE_PLUGIN_ROOT}/scripts/suggest_hooks.py` with the category, objective and topic:

```bash
python ${CLAUDE_PLUGIN_ROOT}/scripts/suggest_hooks.py --category <category> --objective <objective> --topic "<topic>"
```
