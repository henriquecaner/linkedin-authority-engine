...
description: |
  ...
  user: "/linkedin post guided — I want a post about leadership during a crisis"
  ...
  user: "/linkedin thread — topic: why executives fail in the transition to senior leadership"
